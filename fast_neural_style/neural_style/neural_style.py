...
def main():
    ...
    train_arg_parser.add_argument('--mps', action='store_true', help='Use MPS backend for Apple Silicon devices')
...
# python neural_style/neural_style.py train --dataset ./train2014 --style-image ./images/style-images/candy.jpg --save-model-dir ./models --epochs 2 --cuda 1  
# python neural_style/neural_style.py eval --content-image images/content-images/amber.jpg --model models/result.model --output-image result.jpg --cuda 0
